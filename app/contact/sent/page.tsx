...
export default function ContactSent() {
  return (
    <div className="mx-auto flex w-full flex-col gap-16 border-t-4 border-t-purple-700 bg-white px-6 pb-12 pt-8 shadow-sm dark:bg-stone-800 sm:my-12 sm:max-w-xl sm:px-10">
